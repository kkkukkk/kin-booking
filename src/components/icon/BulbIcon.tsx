...
export const BulbIcon = ({ className = "w-4 h-4" }: BulbIconProps) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`bi bi-lightbulb ${className}`}
	     viewBox="0 0 16 16">
		<path
