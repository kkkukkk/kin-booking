...
const LoginClient = () => {
	...
	return (
		<div className={"flex flex-col md:flex-row gap-8 md:gap-16 h-full"}>
			<div className={"hidden md:flex justify-center item-center md:w-2/3"}>
				{
					imagePending
			...
			<div className={"flex flex-col md:w-1/3 h-full gap-8 mt-2 md:gap-16 md:mt-6"}>
				<div className={"flex justify-center items-center flex-grow-[2]"}>
					<Logo width={400} priority={true}/>
				</div>
				<div className={"flex flex-col gap-2 flex-grow-[3.5]"}>
					<Input 
						placeholder="이메일" 
						name={"email"} 
					...
					<div className={"text-sm text-right mt-2 md:text-base"}>
						<Link
							href={"/auth/find"}
							className={clsx(
