	...
	return (
		<section>
			...
			<article className="mb-4">
				<h3 className="font-semibold text-base md:text-xl mb-2">1. 환불 기준</h3>
				<ul className="text-sm md:text-lg list-disc pl-5">
					...
					<li>공연일 기준 <strong>{policy.cancelableUntil}일</strong> 전까지 취소 가능합니다.</li>
					<li>
						공연 <strong>당일</strong> 및 이후 취소 시 환불이 불가능합니다.
					</li>
				</ul>
			</article>

			<article className="mb-4">
				<h3 className="font-semibold text-base md:text-xl mb-2">2. 유의 사항</h3>
				<ul className="text-sm md:text-lg list-disc pl-5">
					<li>공연별 티켓의 부분 환불은 불가능합니다.</li>
					<li>예매 취소 시, 사용하신 송금 계좌로 환불됩니다.</li>
					<li>환불 요청은 관리자 확인 후 순차적으로 처리됩니다.</li>
				</ul>
			</article>

			<article>
				<h3 className="font-semibold text-base md:text-xl mb-2">3. 티켓 양도</h3>
				<ul className="text-sm md:text-lg list-disc pl-5">
					<li>본 공연은 티켓 양도가 가능합니다.</li>
					<li>티켓 양도는 마이 페이지 내 <strong>티켓 관리</strong> 메뉴에서 가능합니다.</li>
					<li>양도받은 티켓의 소유권은 양수인에게 있으며, 동일한 권한으로 입장 및 취소·환불이 가능합니다.</li>
					<li>양도 완료 후에는 양도인의 취소 및 환불이 불가능하니, 신중히 결정해 주시기 바랍니다.</li>
					<li>양도받은 티켓을 환불할 경우, 별도의 환불 계좌를 입력해야 합니다.</li>
				</ul>
			</article>
